...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Nobita") || (event.body.toLowerCase() == "𝐍𝐎𝐁𝐈𝐓𝐀 bai") || (event.body.toLowerCase() == "@𝐍𝐎𝐁𝐈𝐓𝐀 ッ") || (event.body.toLowerCase() == "ইউসুফ")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝐍𝐎𝐁𝐈𝐓𝐀 ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐍𝐎𝐁𝐈𝐓𝐀.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/T.nobita.csd\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:𝐍𝐎𝐁𝐈𝐓𝐀 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস 𝐍𝐎𝐁𝐈𝐓𝐀 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝐍𝐎𝐁𝐈𝐓𝐀 ッ❤️ তাকে সবাই ইউসুফ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami 𝐍𝐎𝐁𝐈𝐓𝐀") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Sizuka") || (event.body.toLowerCase() == "@সিজুকা ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস ইউসুফ এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Sizuka") || (event.body.toLowerCase() == "Sizuka")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 𝐍𝐎𝐁𝐈𝐓𝐀 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "alien") || (event.body.toLowerCase() == "এলিয়েন")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 𝐍𝐎𝐁𝐈𝐓𝐀 এর শালী এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Esrat") || (event.body.toLowerCase() == "ইসরাত")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 𝐍𝐎𝐁𝐈𝐓𝐀 এর সালি এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Sabbir Ahmed ") || (event.body.toLowerCase() == "সাব্বির")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস 𝐍𝐎𝐁𝐈𝐓𝐀'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>𝐘𝐨𝐮𝐫 𝐗𝐚𝐧 😚😘🥰 𝗯𝗼𝘁", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "sinha") || (event.body.toLowerCase() == "সিনহা") || (event.body.toLowerCase() == "চুপ কর") || (event.body.toLowerCase() == "chup kor")) {
     return api.sendMessage("একটু সম্মান করে কথা বল , এইটা নবিতার শাশুড়ি", threadID);
  };

   if ((event.body.toLowerCase() == "ami Nobita") || (event.body.toLowerCase() == "kire")) {
